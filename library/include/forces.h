...
void compute_stress_tensor_forces_pbc(int n, double eps_s, double eps_int, int n_p, double L, double h, double *phi, const unsigned int *region, const unsigned int *st_owner, double *eps_x, double *eps_y, double *eps_z, double *pos, double *solv_radii, double *forces);
void compute_stress_tensor_forces(int n, double eps_s, double eps_int, int n_p, double L, double h, double *phi, const unsigned int *region, const unsigned int *st_owner, double *eps_x, double *eps_y, double *eps_z, double *pos, double *solv_radii, double *forces, int use_pbc);
